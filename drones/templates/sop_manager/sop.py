...
# SOP Sections
sop_sections = {
    "1. Purpose": "This document outlines the Standard Operating Procedures (SOPs) for Sky Guy LLC, a professional drone service provider specializing in aerial photography, videography, and inspection services.",
    "2. Scope": "These procedures apply to all drone operations conducted by Sky Guy using DJI Mavic 3 Pro aircraft, under FAA Part 107 regulations.",
    "3. Responsibilities": (
...
sop_doc_path = "/mnt/data/SkyGuy_SOP.docx"
